...
active_slice: slice-010-wan2.2-exact-first-last-full-render-authorized
next_slice: execute-exactly-one-guarded-slice-010-full-render
postponed_slice: slice-004-rights-ledger-foundation
active_risks: ["production-model-not-accepted", "slice-008-reference-rights-unresolved", "wan2.2-full-run-envelope-unmeasured", "slice-010-one-attempt-only", "parallel-inference-out-of-scope"]
...
## Active Slice
- Slice 010 authorizes one guarded Wan2.2 first/last-frame render with exact 832×480 sizing; all other Slice 009 parameters remain frozen.
- The pinned direct Wan CLI supports experimental A14B `--last-image`; the generic wrapper does not expose it.
- Slice 009 produced no video. Slice 010 has a new marker/output and permits no retry.
...
- Only the single exact Slice 010 launch is authorized. Any retry, offline duplicate, tuning, download, runtime installation, or concurrency claim requires another exact owner-approved slice.
